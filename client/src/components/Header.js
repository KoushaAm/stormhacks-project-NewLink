      ...
      <div className="sticky backdrop-blur-md bg-transparent top-0 z-50">
        <div className="flex justify-between items-center p-3 ">
          <Link to="/" className="flex items-center space-x-4 ml-4 md:ml-24">
            <img src="https://cdn-icons-png.flaticon.com/512/6509/6509383.png" alt="SFUConnect Logo" className="h-6 w-6" />
          ...
          <nav className="flex items-center justify-center space-x-2 md:space-x-4 mr-4 md:mr-24">
            <NavItem to="/chat"><strong>Chat</strong></NavItem>
            <NavItem to="/connect"><strong>Connect</strong></NavItem>
            <NavItem to="/organisations"><strong>Organisations</strong></NavItem>
