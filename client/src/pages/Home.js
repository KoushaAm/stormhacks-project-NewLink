                ...
                <div className="px-4 py-2">
                    ...
                    {messagesLoading && (
                        <motion.div
                            ...
                            transition={{ duration: 0.5 }}
                        >
                            <div className="rounded-lg p-2 shadow max-w-sm bg-white flex justify-center items-center">
                                <div className="loader"></div>
                                <div class='flex px-2 py-2 space-x-2 justify-between items-center bg-white white:invert'>
                                    ...
                                    <div class='h-2 w-2 mr-12 bg-black rounded-full animate-bounce'></div>
                                </div>
                            </div>
                        </motion.div>
                    )}  
